...
Puede visualizar el archivo detallado realizado en Jupyter Notebook con Código Python: [Analysis Customer Shopping Trends.ipynb]
(https://jupyter.org/try-jupyter/lab/index.html?path=notebooks%2FAnalysis+Customer+Shopping+Trends.ipynb)
Donde se realizó:
